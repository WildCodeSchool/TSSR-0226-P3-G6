...
| **IPBX01** | Serveur VoIP - FreePBX | Adaptateur 1 : LAN (Réseau Interne) | 172.16.20.30/24<br>Passerelle : 172.16.20.254<br>DNS : 172.16.20.10 | `root` / `Azerty100*` |
...
![schema](Ressources/projet3drawio.png)
